...
public class FileSystemStorageService implements StorageService {
	...
	public void init() {
		try {
			...
			throw new StorageException("Qovluq yaradila blm'di", e);
		}
	}
	@Override
	...
	public Resource loadAsResource(String filename) {
		try {
			...
			if (resource.exists() || resource.isReadable()) {
				...
				throw new StorageFileNotFoundException("Fayl yadda saxlana bilmedi" + filename);
			}
		} catch (MalformedURLException e) {
			throw new StorageFileNotFoundException("Fayl yadda saxlana bilmedi" + filename, e);
		}
	}
	@Override
